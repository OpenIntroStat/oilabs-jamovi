...
Since sample size is irrelevant to this discussion, let's just set it to some value ($n = 1000$) and use this value in our calculations. In the dataset [here](https://github.com/OpenIntroStat/oilabs-jamovi/raw/main/06_inf_for_categorical_data/more/me.csv), there are two columns. The first is a variable `p` that is a sequence from 0 to 1 with each number incremented by 0.01.
