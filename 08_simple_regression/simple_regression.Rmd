...
Look at a scatter plot for these variables, and set the `Regression Line` option is set to `Linear`.  This will overlay the least-squares regression line over the scatterplot.
...
6.  If someone saw the least squares regression line and not the actual data, how would they predict a country's personal freedom score for one with a rating of 3 for `pf_expression_control`?
