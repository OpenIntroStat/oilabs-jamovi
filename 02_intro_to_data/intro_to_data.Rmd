...
Let's start by examing the distribution of departure delays of all flights with a histogram. Select `Exploration`, then `Description`, then move the variable `dep_delay` to the `Variables` box. Click `Plots`, then check the `Histograms` box.
