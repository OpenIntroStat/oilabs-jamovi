...
In JASP, this is done in the `Show Distributions` section of the Normal menu. Within this menu, make sure parameters is set to $\mu, \sigma$, and mean and standard deviation are correct, then check the `Probability` box under `Highlight`. Select "from 0 to $\infty$", then chance the 0 to 600.
