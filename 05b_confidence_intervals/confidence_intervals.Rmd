...
In essence, bootstrapping assumes that there are more of observations in the population like the ones in the observed sample.
...
This process will find the 95% confidence interval for proportion of US adults who think climate change affects their local community.
...
To recap: even though we don't know what the full population looks like, we're 95% confident that the true proportion of US adults who think climate change affects their local community is between the two bounds reported as the 2.5th percentile and the 97.5th percentile.
...
In the next part of the lab, you will collect many samples to learn more about how sample proportions and confidence intervals constructed based on those samples vary from one sample to another.  This process would look like:
...
2.  Using data from the one sample you have (`samp`), calculate a confidence interval for the proportion of US adults who think climate change is affecting their local community with a confidence level of your choosing (other than 95%).  The number of people in this sample who think climate change is affecting their local community was determined earlier, in Exercise 1.  Also provide an interpretation of your confidence interval.
