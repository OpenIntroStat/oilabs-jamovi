...
1.  Using visualization and summary statistics, describe the distribution of the `weight` variable.  How many observations are we missing weights from?
...
4.  Write the hypotheses for testing if the average weights are different for those who exercise at least three times a week, and those who don't.
...
5. What is the value of the $T$ test statistic?
...
9.  Calculate a 95% confidence interval for the average height in meters (`height`) and interpret it in context.  For a single variable, this can be done using the Descriptives analysis.
